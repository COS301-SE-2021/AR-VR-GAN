...
class VAE(nn.Module):
    def __init__(self, latent_size = 1) -> None:
        super(VAE, self).__init__()
        self.latent_size = latent_size
        # Applies a linear transformation to the incoming data: y = xA^T + by=xAT+b
        # self.fc1 = nn.Linear(784, 400)
        # self.fc21 = nn.Linear(400, 2) # Orginally 400 by 200
        # self.fc22 = nn.Linear(400, 2)
        # self.fc3 = nn.Linear(2, 400)
        # self.fc4 = nn.Linear(400, 784)
        self.fc1 = nn.Linear(784, 400)
        self.fc21 = nn.Linear(400, latent_size) # Orginally 400 by 200
        self.fc22 = nn.Linear(400, latent_size)
        self.fc3 = nn.Linear(latent_size, 400)
        self.fc4 = nn.Linear(400, 784)

    def set_latent_size(self, size) -> None:
